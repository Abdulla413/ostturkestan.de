...
function PostCard({ post }) {
  return (
    <div className="gb-white shadow-lg rounded-lg p-0 lg:p-8 pb-12 mb-8">
      ...
      <h1 className="transation duration-200 text-center mb-8 curser-pointer hover:text-pink-600 text-3xl font-semibold">
